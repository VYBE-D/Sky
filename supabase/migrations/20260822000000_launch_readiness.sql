create unique index if not exists settings_workspace_key_uq on public.settings(workspace_id, key);
create unique index if not exists facebook_pages_workspace_page_uq on public.facebook_pages(workspace_id, page_id);
create unique index if not exists facebook_comments_workspace_external_uq on public.facebook_comments(workspace_id, external_id);
create unique index if not exists facebook_posts_workspace_external_uq on public.facebook_posts(workspace_id, external_id);
...
create index if not exists research_items_workspace_created_idx on public.research_items(workspace_id, created_at desc);
create index if not exists approval_queue_workspace_status_idx on public.approval_queue(workspace_id, status, created_at desc);
